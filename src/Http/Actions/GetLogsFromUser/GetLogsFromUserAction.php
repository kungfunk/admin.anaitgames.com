<?php
namespace Http\Actions\GetLogsFromUser;

use Psr\Http\Message\ServerRequestInterface as Request;
use Psr\Http\Message\ResponseInterface as Response;
use Domain\User\LogsRepository as LogsRepository;
use Domain\User\UsersRepository as UsersRepository;
use Http\Actions\GetLogsFromUser\GetLogsFromUserResponder as Responder;
use Http\Actions\GetLogsFromUser\GetLogsFromUserInput as Input;
